...
7.5.2026
Aki Karppinen put some spondors file-names for pictures here...
        ...
        <Grid item xs={12} sm={12} container className={classes.addPadding}>
            ...
            <Grid item xs={12} sm={12}>
              <Collapse in={expanded} timeout="auto" unmountOnExit>
                ...
                {(isXS && segmentdata.Nimi !== "Metsä") && <Grid container xs={12} className={classes.sponsorContainer} >
                  {<Grid item xs={6}>
                    { <a href="https://www.google.fi" target="_blank" rel="noopener noreferrer" >
                      <img src="DISCOVER_MUONIO_LOGO.png" alt="Sponsor logo" className={classes.sponsor} />
                    </a> }
                  </Grid>}
                  {<Grid item xs={6}>
                    {
          ...
          {(isXS && (isEnabled(3) || isEnabled(4) || description !== "")) &&
            <Grid item xs={12} align="center">
              ...
              >
                <img src="<%= request.getContextPath() %>/icons/expand.svg" width="80%" height="15px" alt="expand"/* fill="black"*/></img>
              </IconButton>
            </Grid>
          }
        </Grid>}
